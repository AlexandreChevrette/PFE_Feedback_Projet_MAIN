...
class ADS131M04 {
  public:
    ADS131M04(int8_t _clkoutPin, SPIClass* _spi, int8_t _clockCh = 1, uint8_t _misoPin, uint8_t _mosiPin, uint8_t _sclkPin);
    void begin(void);
  ...
  private:
    int8_t clkoutPin, clockCh, sclkPin, misoPin, mosiPin;
    SPIClass* spi;
    bool initialised;
